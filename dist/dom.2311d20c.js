...
window.dom = {
    create: function create(string) {
        //创建一个节点
        var container = document.createElement("template"); //template标签可以容纳所有标签
    ...
    empty: function empty(node) {
        var childNodes = node.childNodes; //等价于const chileNodes = node.childNodes
...
//# sourceMappingURL=/dom.2311d20c.map